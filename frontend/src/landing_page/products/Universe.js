    ...
    <div className="container mt-5">
      <div className="row text-center">
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/zerodhaFundhouse.png"  width={199} height={52}/>
          <p className="text-small text-muted">Our asset management venture
that is creating simple and transparent index
funds to help you save for your goals.</p>
        </div>
        <div className="col-4 p-3 mt-5">
          <img src="media/images/sensibullLogo.svg"  width={199} height={52}/>
...
data points like open interest, FII/DII, and more.</p>
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/tijorilogo.png"  width={199} height={52} />
          <p className="text-small text-muted">Investment research platform
that offers detailed insights on stocks,
sectors, supply chains, and more.</p>
        </div>
        <div className="col-4 p-3 mt-5 image-container">
          <img src="media/images/streakLogo.png"  width={199} height={52} />
...
baskets of stocks on ETFs.</p>
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/dittoLogo.png" width={199} height={52}/>
